...
func parsePythonDecoratedMethod(
	...
	return &outbound.SemanticCodeChunk{
		...
		StartPosition: valueobject.Position{Row: functionNode.StartPos.Row, Column: functionNode.StartPos.Column},
		EndPosition:   valueobject.Position{Row: functionNode.EndPos.Row, Column: functionNode.EndPos.Column},
		Content:       content,
		Documentation: documentation,
		Visibility:    determinePythonVisibility(methodName),
		Parameters:    parameters,
