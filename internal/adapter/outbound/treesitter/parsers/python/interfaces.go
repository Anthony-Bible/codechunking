...
func createInterfaceFromClass(
	...
	chunk := &outbound.SemanticCodeChunk{
		...
		StartPosition: valueobject.Position{Row: classNode.StartPos.Row, Column: classNode.StartPos.Column},
		EndPosition:   valueobject.Position{Row: classNode.EndPos.Row, Column: classNode.EndPos.Column},
		Content:       content,
