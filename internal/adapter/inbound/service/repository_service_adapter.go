...
func (a *RepositoryServiceAdapter) CreateRepository(
	ctx context.Context,
...
func (a *RepositoryServiceAdapter) ListRepositories(
	ctx context.Context,
	listQuery dto.RepositoryListQuery,
...
func (a *RepositoryServiceAdapter) GetRepositoryJobs(
	ctx context.Context,
	repositoryID uuid.UUID,
	listQuery dto.IndexingJobListQuery,
...
func (a *RepositoryServiceAdapter) GetIndexingJob(
	ctx context.Context,
