...
func TestLargeFunctionChunkerExtractSplitOverlapContext(t *testing.T) {
    ...
    return veryLongVariableName;}`,
			...
			maxSize:       30,
			expected:      "    return veryLongVariableName;",
			shouldContain: []string{"return"},
			shouldExclude: []string{"const veryLongVariableName"},
		},
		{
    ...
    return x;}`,
			...
			maxSize:       20,
			expected:      "    const x = 1;",
			shouldContain: []string{"const x"},
			shouldExclude: []string{"veryLongLineThatExceeds"},
		},
		{
    ...
    return x;}`,
			...
			shouldExclude: []string{"This is a comment"},
		},
	}
