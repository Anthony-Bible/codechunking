...
// TestJavaScriptClassExtraction_TreeSitterIntegration_RedPhase tests tree-sitter AST node detection.
...
func TestJavaScriptClassExtraction_TreeSitterIntegration_RedPhase(t *testing.T) {
...
// TestJavaScriptClassExtraction_BasicClassDeclarations_RedPhase tests basic ES6 class detection.
...
func TestJavaScriptClassExtraction_BasicClassDeclarations_RedPhase(t *testing.T) {
...
// TestJavaScriptClassExtraction_ClassExpressions_RedPhase tests class expression detection.
...
func TestJavaScriptClassExtraction_ClassExpressions_RedPhase(t *testing.T) {
...
// TestJavaScriptClassExtraction_MixinFactories_RedPhase tests mixin factory function detection.
...
func TestJavaScriptClassExtraction_MixinFactories_RedPhase(t *testing.T) {
...
// TestJavaScriptClassExtraction_StaticMemberMetadata_RedPhase tests static member metadata extraction.
...
func TestJavaScriptClassExtraction_StaticMemberMetadata_RedPhase(t *testing.T) {
...
// TestJavaScriptClassExtraction_ErrorHandling_RedPhase tests error conditions and edge cases.
...
func TestJavaScriptClassExtraction_ErrorHandling_RedPhase(t *testing.T) {
	ctx := context.Background()
	adapter := treesitter.NewSemanticTraverserAdapter()
...
// TestJavaScriptClassExtraction_ComplexIntegration_RedPhase tests comprehensive real-world scenarios.
...
func TestJavaScriptClassExtraction_ComplexIntegration_RedPhase(t *testing.T) {
