...
func TestJavaScriptClassExtraction(t *testing.T) {
	...
	t.Run("Simple ES6 class with constructor and methods", func(t *testing.T) {
		sourceCode := `
class SimpleClass {
	constructor(name) {
		this.name = name;
...
`
	...
	t.Run("Class inheritance with extends keyword", func(t *testing.T) {
		sourceCode := `
class ParentClass {
...
`
	...
	t.Run("Getter and setter methods", func(t *testing.T) {
		sourceCode := `
...
`
	...
	t.Run("Private fields and methods", func(t *testing.T) {
		sourceCode := `
class PrivateClass {
...
`
	...
	t.Run("Class decorators", func(t *testing.T) {
		sourceCode := `
@decorator
...
`
	...
	t.Run("Abstract classes", func(t *testing.T) {
		sourceCode := `
class AbstractClass {
	constructor() {
