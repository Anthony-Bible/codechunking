...
func TestLanguageDispatcher_NewLanguageDispatcher(t *testing.T) {
	...
	assert.Len(t, supportedLanguages, 2, "Should support 2 languages (Go and Python)")
...
func TestLanguageDispatcher_IsLanguageSupported(t *testing.T) {
	...
	testCases := []struct {
		...
		{"JavaScript language", valueobject.LanguageJavaScript, false},
	}
